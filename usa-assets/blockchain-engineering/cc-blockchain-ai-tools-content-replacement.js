(function () {
  ...
  var items = [
    "<strong>Introduction to Blockchain:</strong> Learn the basics of blockchain, including its components and applications.",
    "<strong>Smart Contracts &amp; Solidity:</strong> Get hands-on experience building decentralized applications (dApps) and smart contracts.",
    "<strong>Cryptocurrencies &amp; DeFi:</strong> Understand the role of blockchain in cryptocurrencies and decentralized finance.",
    "<strong>Blockchain Security &amp; Privacy:</strong> Learn how to secure blockchain-based applications.",
    "<strong>Blockchain Governance &amp; Scaling:</strong> Explore governance models and scalability solutions for blockchain platforms.",
    "<strong>Bootcamp Advantage:</strong> This bootcamp is uniquely designed to build you into a world class blockchain engineer, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Blockchain Engineering</span> with AI, the Right Way</h2>' +
