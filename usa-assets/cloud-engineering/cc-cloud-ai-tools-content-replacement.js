(function () {
  ...
  var items = [
    "<strong>Introduction to Cloud Computing:</strong> Understand cloud fundamentals, types, and service models (IaaS, PaaS, SaaS).",
    "<strong>Cloud Infrastructure &amp; Networking:</strong> Learn the core components of cloud services, including compute, storage, and networking.",
    "<strong>Cloud Security &amp; Compliance:</strong> Understand how to ensure secure cloud systems and meet compliance regulations.",
    "<strong>Automation &amp; DevOps:</strong> Learn how to automate deployments and manage cloud systems efficiently.",
    "<strong>Cloud Certifications:</strong> Prepare for AWS, Microsoft Azure, and Google Cloud certifications to boost your job prospects.",
    "This bootcamp is uniquely designed to build you into a world class cloud engineer, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Cloud Engineering</span> with AI, the Right Way</h2>' +
