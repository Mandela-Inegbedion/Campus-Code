(function () {
  ...
  var items = [
    "<strong>Introduction to Cybersecurity:</strong> Learn the core concepts of cybersecurity and its importance.",
    "<strong>Networking &amp; Security Fundamentals:</strong> Understand network infrastructure, protocols, and how to secure them.",
    "<strong>Ethical Hacking &amp; Penetration Testing:</strong> Gain practical experience in penetration testing tools and techniques.",
    "<strong>Cryptography &amp; Encryption:</strong> Learn to implement encryption protocols for data protection.",
    "<strong>Security Operations &amp; Incident Response:</strong> Understand how to build a security operations center (SOC) and manage incidents.",
    "<strong>Bootcamp Advantage:</strong> This bootcamp is uniquely designed to build you into a world class cybersecurity engineer, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Cybersecurity Engineering</span> with AI, the Right Way</h2>' +
