(function () {
  ...
  var items = [
    "<strong>Introduction to Data Analytics & Data Science:</strong> Learn the fundamentals of data analysis and the role of a data scientist.",
    "<strong>Data Wrangling & Preprocessing:</strong> Understand how to clean and prepare data for analysis.",
    "<strong>Statistical Analysis:</strong> Learn probability, hypothesis testing, and other core statistical concepts.",
    "<strong>Machine Learning:</strong> Study supervised and unsupervised learning techniques, including regression, classification, clustering, and neural networks.",
    "<strong>Data Visualization & Reporting:</strong> Master the art of presenting data in a compelling and easily understandable way.",
    "This bootcamp is uniquely designed to build you into a world class data analyst, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Data Analytics</span> with AI, the Right Way</h2>' +
