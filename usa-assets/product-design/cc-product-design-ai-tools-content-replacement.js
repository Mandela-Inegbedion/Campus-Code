(function () {
  ...
  var items = [
    "<strong>Introduction to Product Design:</strong> Understanding UX vs UI, design thinking, and problem-solving methodologies.",
    "<strong>User Research & Experience Design:</strong> Conducting user interviews, creating personas, and mapping user journeys.",
    "<strong>Wireframing & Prototyping:</strong> Using Figma to create low and high-fidelity wireframes.",
    "<strong>UI Design & Visual Aesthetics:</strong> Exploring typography, color theory, and layout design principles.",
    "<strong>Design Systems & Component Libraries:</strong> Building scalable design systems for consistency.",
    "<strong>Usability Testing & Iteration:</strong> Conducting A/B testing, gathering feedback, and refining designs. This bootcamp is uniquely designed to build you into a world class project manager, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Product Design</span> with AI, the Right Way</h2>' +
