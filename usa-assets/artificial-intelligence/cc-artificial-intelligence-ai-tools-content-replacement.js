(function () {
  ...
  var items = [
    "<strong>Introduction to AI:</strong> Dive into complex AI models such as convolutional neural networks (CNNs) and recurrent neural networks (RNNs).",
    "<strong>Machine Learning Basics:</strong> Learn about algorithms like linear regression, decision trees, and k-nearest neighbors.",
    "<strong>Deep Learning & Neural Networks:</strong> Understand how to ensure secure cloud systems and meet compliance regulations.",
    "<strong>Natural Language Processing:</strong> Study text and speech recognition techniques used in AI applications.",
    "<strong>AI Ethics & Future Trends:</strong> Explore the ethical implications of AI and its future potential.",
    "This bootcamp is uniquely designed to build you into a world class artificial intelligence engineer, with a globally recognized certificate and job placement support.",
  ];
  ...
  function render() {
    ...
    record.innerHTML =
      ...
      '<h2 class="cc-se-ai-heading"><span class="accent">Learn Artificial Intelligence (AI)</span>, the Right Way</h2>' +
